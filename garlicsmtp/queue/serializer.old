...
class QueueSerializer:
    ...
    @staticmethod
    def to_dict(item: QueueItem) -> dict:
    ...
    @staticmethod
    def to_json(item: QueueItem) -> str:
    ...
    def from_dict(data: dict) -> QueueItem:
        ...
        message = MailMessage(
            envelope=Envelope(**data["message"]["envelope"]),
            headers=MailHeaders(**data["message"]["headers"]),
            metadata=Metadata(**data["message"]["metadata"]),
        ...
        return QueueItem(
            ...
            next_retry=(
                datetime.fromisoformat(data["next_retry"])
    ...
    @staticmethod
    def from_json(text: str) -> QueueItem:
